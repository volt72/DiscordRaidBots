...
namespace Bot
{
    class Program
    {
        ...
        {
            public string owner_snowflake { get; set; } //updated this from int to string to compensate for the broken source. I hope it works after this!! ( I personally dont test as I don't want to get termed for API abuse)
